	...
	return {
		email: {
			permitted: {
				...
				errorMessage: `Only ${options.permitted} email addresses are permitted.`,
			},
			restricted: {
				value: options.restricted || null,
				errorMessage: options.permitted ? `Only ${options.permitted} email addresses are permitted.` : `${options.restricted} email addresses cannot be used.`,
			}
		},
		password: {
			minLength: {
